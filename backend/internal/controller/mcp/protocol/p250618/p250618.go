...
type AudioContent struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta AudioContentMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type AudioContentMeta map[string]any
...
type BlobResourceContents struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta BlobResourceContentsMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type BlobResourceContentsMeta map[string]any
...
type CallToolRequestParamsArguments map[string]json.RawMessage // WARNING: manually modified to json.RawMessage from any
...
type CallToolResult struct {
	...
	StructuredContent CallToolResultStructuredContent `json:"structuredContent,omitempty" yaml:"structuredContent,omitempty" mapstructure:"structuredContent,omitempty"`
}

// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type CallToolResultMeta map[string]any

// An optional JSON object that represents the structured result of the tool call.
type CallToolResultStructuredContent map[string]any
...
// Present if the client supports elicitation from the server.
type ClientCapabilitiesElicitation map[string]any
...
type CompleteRequestParamsContext struct {
	...
	Arguments CompleteRequestParamsContextArguments `json:"arguments,omitempty" yaml:"arguments,omitempty" mapstructure:"arguments,omitempty"`
}

// Previously-resolved variables in a URI template or prompt.
type CompleteRequestParamsContextArguments map[string]string
...
var enumValues_CreateMessageRequestParamsIncludeContext = []any{
	"allServers",
	"none",
	"thisServer",
}
...
type CreateMessageResultContent struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta TextContentMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type CreateMessageResultMeta map[string]any
...
type ElicitRequestParamsRequestedSchema struct {
	...
	Properties ElicitRequestParamsRequestedSchemaProperties `json:"properties" yaml:"properties" mapstructure:"properties"`
...
type ElicitRequestParamsRequestedSchemaProperties map[string]PrimitiveSchemaDefinition
...
type ElicitResult struct {
	...
	Content ElicitResultContent `json:"content,omitempty" yaml:"content,omitempty" mapstructure:"content,omitempty"`
}
...
var enumValues_ElicitResultAction = []any{
	"accept",
	"cancel",
	"decline",
}
...
// The submitted form data, only present when action is "accept".
// Contains values matching the requested schema.
type ElicitResultContent map[string]any

// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ElicitResultMeta map[string]any
...
type EmbeddedResource struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta EmbeddedResourceMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type EmbeddedResourceMeta map[string]any

type EmbeddedResourceResource struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta TextResourceContentsMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type GetPromptResultMeta map[string]any
...
type ImageContent struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta ImageContentMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ImageContentMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ListPromptsResultMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ListResourceTemplatesResultMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ListResourcesResultMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ListRootsResultMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ListToolsResultMeta map[string]any
...
var enumValues_LoggingLevel = []any{
	"alert",
	"critical",
	"debug",
	"emergency",
...
var enumValues_NumberSchemaType = []any{
	"integer",
	"number",
}
...
type Prompt struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta PromptMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type PromptListChangedNotificationParamsMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type PromptMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ReadResourceResultMeta map[string]any
...
type RequestId any // WARNING: manually modified to any where it was previously int
...
type Resource struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta ResourceMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
type ResourceContents struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta ResourceContentsMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ResourceContentsMeta map[string]any
...
type ResourceLink struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta ResourceLinkMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ResourceLinkMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ResourceListChangedNotificationParamsMeta map[string]any
...
type ResourceTemplate struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta ResourceTemplateMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ResourceTemplateMeta map[string]any
...
type Root struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta RootMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type RootsListChangedNotificationParamsMeta map[string]any
...
// Present if the server supports argument autocompletion suggestions.
type ServerCapabilitiesCompletions map[string]any
...
var enumValues_StringSchemaFormat = []any{
	"date",
	"date-time",
	"email",
	"uri",
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type TextContentMeta map[string]any
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type TextResourceContentsMeta map[string]any
...
type Tool struct {
	// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
	// notes on `_meta` usage.
	Meta ToolMeta `json:"_meta,omitempty" yaml:"_meta,omitempty" mapstructure:"_meta,omitempty"`
...
// See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for
// notes on `_meta` usage.
type ToolListChangedNotificationParamsMeta map[string]any
...
type ToolOutputSchema struct {
	// Properties corresponds to the JSON schema field "properties".
	Properties ToolOutputSchemaProperties `json:"properties,omitempty" yaml:"properties,omitempty" mapstructure:"properties,omitempty"`
...
type ToolOutputSchemaProperties map[string]map[string]any
